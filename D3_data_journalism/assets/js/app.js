...
function makeResponsive() {
    ...
    // if the SVG area isn't empty when the browser loads, remove, replac and resize
    if (!svgArea.empty()) {
        svgArea.remove();
    }
    ...
    // Import data from the data.csv file using D3 and parse the data to convert to numerical values
    ...
    d3.csv("assets/data/data.csv").then(censusData => {
        ...
        // set chart x,y parameters
      
        var xAxisFactor = "poverty";
        var yAxisFactor = "healthcare";

        // set active information card
        ...
        // use updateTooltip function to create toolTip
        // ====================================================
        updateTooltip(xAxisFactor, yAxisFactor, circlesGroup, stateLabels);

        // Create event listeners for changes in axes 
        // =================================
...
// use functions for x,y domains (scaling )
// ==================================================  
...
// use functions to update axes transitions
// =====================================
...
// use function to update scatter plot (circles and text labels)
// ================================================================
...
// use function to update Tooltip
// ================================================================
function updateTooltip(xAxisFactor, yAxisFactor, circlesGroup, stateLabels) {
    ...
    // Create tooltip in the chart for circles and state labels
    // =======================================================================
